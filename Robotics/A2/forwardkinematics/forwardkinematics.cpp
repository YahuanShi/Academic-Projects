...
void ForwardKinematicsPuma2D::computeJ()
{
   ...
   //row vector
   J[0][0] = l3 * cos(angles[0] + angles[1] + angles[2]) 
           + l2 * cos(angles[0] + angles[1]) 
           - l1 * sin(angles[0]);
   J[0][1] = l3 * cos(angles[0] + angles[1] + angles[2]) 
           + l2 * cos(angles[0] + angles[1]);
   J[0][2] = l3 * cos(angles[0] + angles[1] + angles[2]);

   //row vector
   J[1][0] = l3 * sin(angles[0] + angles[1] + angles[2]) 
           + l2 * sin(angles[0] + angles[1]) 
           + l1 * cos(angles[0]);
   J[1][1] = l3 * sin(angles[0] + angles[1] + angles[2]) 
           + l2 * sin(angles[0] + angles[1]);
