...
def parse_cli_args() -> VisualizerOptions:
    ...
    parser = argparse.ArgumentParser(description="workstation visualizer")
...
class SchedulerVisualizer:
    ...
    def __init__(self, options: VisualizerOptions) -> None:
        ...
        cv2.namedWindow(" Workbench SAR", cv2.WINDOW_NORMAL)
        cv2.resizeWindow("Workbench SAR", CANVAS_WIDTH, CANVAS_HEIGHT)
